...
function preload(){
  ...
  green__BalloonImage = loadImage("green_balloon0.png")
    ...
    if (select_balloon == 1) {
      ...
      { 
        case 1: red.addImage(red_balloonImage);
                 break;
        case 2: pink.addImage(pink_balloonImage);
                 break;
        case 3: blue.addImage (blue_balloonImage);
                 break;
        case 4: green.addImage(green_balloonImage);
                 break;
      }
